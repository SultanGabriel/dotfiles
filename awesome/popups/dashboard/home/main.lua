...
local widget_favorite_apps = require("popups.dashboard.home.favorite_apps")
...
local favorite_apps = wibox.widget {
	header.favorite_apps,
	widget_favorite_apps,
	layout = wibox.layout.fixed.vertical,
	visible = false
}
...
awesome.connect_signal("dashboard::favorite_apps", function()
	home.visible = false
	todo.visible = false
	sys_monitor.visible = false
	settings.visible = false
	favorite_apps.visible = true
