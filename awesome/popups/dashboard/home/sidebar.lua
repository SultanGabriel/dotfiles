...
local favorite_apps = create_button('㋡', color.grey, color.bg_blackest, color.background_dark, color.background_lighter, "dashboard::favorite_apps")


local change_button_color = function(button, other1, other2, other3, other4)
	button:connect_signal("button::release", function()
		button.bg = color.background_lighter
		other1.bg = color.bg_blackest
		other2.bg = color.bg_blackest
		other3.bg = color.bg_blackest
		other4.bg = color.bg_blackest
	end)
end

change_button_color(home, sys_monitor, todo, settings, favorite_apps)
change_button_color(todo, home, sys_monitor, settings, favorite_apps)
change_button_color(sys_monitor, home, todo, settings, favorite_apps)
change_button_color(settings, home, todo, sys_monitor, favorite_apps)
change_button_color(favorite_apps, settings, home, todo, sys_monitor)
