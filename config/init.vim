...
autocmd BufEnter * if tabpagenr('$') == 1 && winnr('$') == 3 && exists('b:NERDTree') && b:NERDTree.isTabTree() | quit | endif
...
" ------------------------------------------------------------------
" I have no idea what the fuck these things are
" Well these have to be ajusted !!!!
